...
public class GuitarTest {
    ...
    public Guitar setupNewGuitar() {
        return new Guitar ("Gibson", "Les Paul Custom", "USA", "xxx", "old", 1999, 10.8, "www.test.url", true, false, 1500.00, 0.00,"electric guitar", "Mahogany", "Lacquer", "Ebony", "5-Ply", "Mahogany", "Set", "1960's Slim Taper", "Ebony", 12.0, 22, "Gibson Style", "Mother of Pearl Block", "Bone", 1.6875, 24.75, "Humbucker", "N/A", "Humbucker", "500K CTS", "500K CTS", "Sprangue .022 uf", "Grover Rotomatic", "Nickel Keystone", "Roller", "Bigsby B7", "3-way", "Bellhat", "5-Ply", "Volume, Tone", "Gibson Hardcase");
    }
    ...
    @Test
    public void setType_acoustic() {
        Guitar testGuitar = setupNewGuitar();
        testGuitar.setType("acoustic guitar");
        assertEquals("acoustic guitar", testGuitar.getType());
    }
}